...
const CLIENTES_INIT = [
  { id:1, ruc:"20512345678", razonSocial:"DISTRIBUIDORA NORTE SAC",   fechaAsig:"2024-03-10", fechaGestion:"2024-07-15", oportunidades:2, estado:"Identificada" },
  { id:2, ruc:"20601234567", razonSocial:"TECNO PERÚ EIRL",           fechaAsig:"2024-02-01", fechaGestion:"2024-08-20", oportunidades:3, estado:"Propuesta Entregada" },
  { id:3, ruc:"20700123456", razonSocial:"COMERCIAL EL SOL SA",       fechaAsig:"2024-04-05", fechaGestion:"2024-09-01", oportunidades:1, estado:"Negociación" },
  { id:4, ruc:"20800234567", razonSocial:"INVERSIONES DELTA SRL",     fechaAsig:"2024-01-20", fechaGestion:"2024-07-30", oportunidades:4, estado:"Negociada Aprobada" },
  { id:5, ruc:"20900345678", razonSocial:"GRUPO ANDINO SAC",          fechaAsig:"2024-05-12", fechaGestion:"2024-10-05", oportunidades:1, estado:"Negociada Rechazada" },
  { id:6, ruc:"20213456789", razonSocial:"BANCO REGIONAL DEL NORTE",  fechaAsig:"2024-03-22", fechaGestion:"2024-09-12", oportunidades:5, estado:"Negociación" },
];
...
export default function Clientes() {
  ...
  const filtrados = useMemo(() => {
    return clientes.filter(c => {
      ...
      const matchD = !desde || c.fechaGestion >= desde;
      const matchH = !hasta || c.fechaGestion <= hasta;
            ...
            {filtrados.map((c, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ padding: "10px 14px" }}>
                    <span style={S.text(12, 700, C.black)}>{dias}d</span>
                  </td>
